...
public:
   ...
   void (ESCALLBACK *btnFunc) (ESContext*, mouse::MouseButton, mouse::MouseEvent, int, int);
};
...
void ESUTIL_API esRegisterButtonFunc( ESContext* esContext,
									  void (ESCALLBACK* buttonFunc) (ESContext*, mouse::MouseButton, mouse::MouseEvent, int, int) );
//
