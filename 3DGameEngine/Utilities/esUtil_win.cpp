...
LRESULT WINAPI ESWindowProc ( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam ) 
{
   ...
   { 
      ...
      case WM_LBUTTONDOWN:
          {
              ESContext* esContext = (ESContext*)(LONG_PTR)GetWindowLongPtr(hWnd, GWL_USERDATA);
              if (esContext && esContext->btnFunc)
                  esContext->btnFunc(esContext, mouse::MouseButton::LEFT_CLICK, mouse::MouseEvent::CLICK, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
          }
          break;
      default: 
...
GLboolean WinCreate ( ESContext *esContext, const char *title )
{
   ...
   wStyle = WS_VISIBLE | WS_POPUP | WS_BORDER | WS_SYSMENU | WS_CAPTION | CS_DBLCLKS;
